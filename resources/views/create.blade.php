...
<section class="px-6 py-40">
    <main class="max-w-lg mx-auto bg-gray-100 border border-gray-300 p-6 rounded-xl">
        <h1 class="text-center font-bold text-xl mt-700">Register</h1>
        ...
        <form method="POST" action="/register" class="mt-10">
            ...
            <div class="mb-6 ">
                ...
                <input class="border border-gray-400 p-2 w-full mb-4" type="text" name="name" id="name" value="{{old('name')}}"
                       required>
                @error('name')
            ...
            <div class="mb-3 ">
                ...
                <input class="border border-gray-400 p-2 w-full mb-4" type="text" name="username" id="username" value="{{old('username')}}"
                       required>
                @error('username')
                <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                @enderror
